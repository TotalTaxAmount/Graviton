...
public class BufferBuilder extends DefaultedVertexConsumer implements BufferVertexConsumer {
   ...
   public static class SortState {
      ...
      SortState(VertexFormat.Mode p_254257_, int p_254533_, @Nullable Vector3f[] p_253742_, float p_253951_, float p_254261_, float p_254368_) {
         this.mode = p_254257_;
         this.vertices = p_254533_;
         this.sortingPoints = p_253742_;
         this.sortX = p_253951_;
         this.sortY = p_254261_;
         this.sortZ = p_254368_;
      }
   }
}