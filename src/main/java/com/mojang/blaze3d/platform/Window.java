...
public final class Window implements AutoCloseable {
   ...
   public void setIcon(IoSupplier<InputStream> p_250818_, IoSupplier<InputStream> p_249199_) {
      RenderSystem.assertInInitPhase();
      ...
      try (MemoryStack memorystack = MemoryStack.stackPush()) {
         ...
         ByteBuffer bytebuffer = this.readIconPixels(p_250818_, intbuffer, intbuffer1, intbuffer2);
         if (bytebuffer == null) {
         ...
         ByteBuffer bytebuffer1 = this.readIconPixels(p_249199_, intbuffer, intbuffer1, intbuffer2);
         if (bytebuffer1 == null) {
   ...
   @Nullable
   private ByteBuffer readIconPixels(IoSupplier<InputStream> p_249586_, IntBuffer p_249069_, IntBuffer p_249100_, IntBuffer p_249695_) throws IOException {
      RenderSystem.assertInInitPhase();
