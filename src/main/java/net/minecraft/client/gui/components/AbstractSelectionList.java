...
public abstract class AbstractSelectionList<E extends AbstractSelectionList.Entry<E>> extends AbstractContainerEventHandler implements Renderable, NarratableEntry {
   ...
   protected void renderHeader(PoseStack p_93458_, int p_93459_, int p_93460_) {
   }
   ...
   public void render(PoseStack p_93447_, int p_93448_, int p_93449_, float p_93450_) {
      ...
      if (this.renderBackground) {
         ...
         int k = 32;
         blit(p_93447_, this.x0, this.y0, (float)this.x1, (float)(this.y1 + (int)this.getScrollAmount()), this.x1 - this.x0, this.y1 - this.y0, 32, 32);
      ...
      if (this.renderHeader) {
         this.renderHeader(p_93447_, l1, l);
      }
      ...
      if (this.renderTopAndBottom) {
         ...
         blit(p_93447_, this.x0, 0, 0.0F, 0.0F, this.width, this.y0, 32, 32);
         blit(p_93447_, this.x0, this.y1, 0.0F, (float)this.y1, this.width, this.height - this.y1, 32, 32);
         RenderSystem.setShaderColor(1.0F, 1.0F, 1.0F, 1.0F);
         int j1 = 4;
         fillGradient(p_93447_, this.x0, this.y0, this.x1, this.y0 + 4, -16777216, 0);
         fillGradient(p_93447_, this.x0, this.y1 - 4, this.x1, this.y1, 0, -16777216);
      }
      ...
      if (i2 > 0) {
         ...
         fill(p_93447_, i, this.y0, j, this.y1, -16777216);
         fill(p_93447_, i, k1, j, k1 + j2, -8355712);
         fill(p_93447_, i, k1, j - 1, k1 + j2 - 1, -4144960);
      }
   ...
   protected void renderItem(PoseStack p_238965_, int p_238966_, int p_238967_, float p_238968_, int p_238969_, int p_238970_, int p_238971_, int p_238972_, int p_238973_) {
      ...
      e.renderBack(p_238965_, p_238969_, p_238971_, p_238970_, p_238972_, p_238973_, p_238966_, p_238967_, Objects.equals(this.hovered, e), p_238968_);
   ...
   protected abstract static class Entry<E extends AbstractSelectionList.Entry<E>> implements GuiEventListener {
      ...
      public void renderBack(PoseStack p_275598_, int p_275556_, int p_275667_, int p_275713_, int p_275408_, int p_275330_, int p_275603_, int p_275450_, boolean p_275434_, float p_275384_) {
      }
