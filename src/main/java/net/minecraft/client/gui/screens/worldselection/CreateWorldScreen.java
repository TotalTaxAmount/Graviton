...
public class CreateWorldScreen extends Screen {
   ...
   public void render(PoseStack p_100890_, int p_100891_, int p_100892_, float p_100893_) {
      ...
      blit(p_100890_, 0, Mth.roundToward(this.height - 36 - 2, 2), 0.0F, 0.0F, this.width, 2, 32, 2);
      super.render(p_100890_, p_100891_, p_100892_, p_100893_);
   }

   public void renderDirtBackground(PoseStack p_275653_) {
      RenderSystem.setShaderTexture(0, LIGHT_DIRT_BACKGROUND);
      int i = 32;
      blit(p_275653_, 0, 0, 0, 0.0F, 0.0F, this.width, this.height, 32, 32);
   }
   ...
   private void applyNewPackConfig(PackRepository p_270272_, WorldDataConfiguration p_270573_, Consumer<WorldDataConfiguration> p_270552_) {
      ...
      }, Util.backgroundExecutor(), this.minecraft).thenAcceptAsync(this.uiState::setSettings, this.minecraft).handle((p_274689_, p_274690_) -> {
         if (p_274690_ != null) {
            LOGGER.warn("Failed to validate datapack", p_274690_);
   ...
   class GameTab extends GridLayoutTab {
      ...
      GameTab() {
         ...
         CreateWorldScreen.this.uiState.addListener((p_275868_) -> {
            cyclebutton.setValue(p_275868_.getGameMode());
            cyclebutton.active = !p_275868_.isDebug();
            cyclebutton.setTooltip(Tooltip.create(p_275868_.getGameMode().getInfo()));
         });
         ...
         CreateWorldScreen.this.uiState.addListener((p_275870_) -> {
         ...
         CreateWorldScreen.this.uiState.addListener((p_275873_) -> {
   ...
   class WorldTab extends GridLayoutTab {
      ...
      WorldTab() {
         ...
         CreateWorldScreen.this.uiState.addListener((p_275876_) -> {
            WorldCreationUiState.WorldTypeEntry worldcreationuistate$worldtypeentry = p_275876_.getWorldType();
         ...
         CreateWorldScreen.this.uiState.addListener((p_275874_) -> {
            this.customizeTypeButton.active = !p_275874_.isDebug() && p_275874_.getPresetEditor() != null;
         });
         GridLayout.RowHelper gridlayout$rowhelper1 = (new GridLayout()).rowSpacing(4).createRowHelper(1);
