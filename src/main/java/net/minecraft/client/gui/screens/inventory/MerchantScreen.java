...
public class MerchantScreen extends AbstractContainerScreen<MerchantMenu> {
   ...
   protected void renderBg(PoseStack p_99143_, float p_99144_, int p_99145_, int p_99146_) {
      ...
      int i = (this.width - this.imageWidth) / 2;
      int j = (this.height - this.imageHeight) / 2;
      blit(p_99143_, i, j, 0, 0.0F, 0.0F, this.imageWidth, this.imageHeight, 512, 256);
      ...
      if (!merchantoffers.isEmpty()) {
         ...
         if (merchantoffer.isOutOfStock()) {
            RenderSystem.setShaderTexture(0, VILLAGER_LOCATION);
            blit(p_99143_, this.leftPos + 83 + 99, this.topPos + 35, 0, 311.0F, 0.0F, 28, 21, 512, 256);
         }
      }
   ...
   private void renderProgressBar(PoseStack p_99153_, int p_99154_, int p_99155_, MerchantOffer p_99156_) {
      ...
      if (i < 5) {
         blit(p_99153_, p_99154_ + 136, p_99155_ + 16, 0, 0.0F, 186.0F, 102, 5, 512, 256);
         ...
         if (j >= k && VillagerData.canLevelUp(i)) {
            ...
            blit(p_99153_, p_99154_ + 136, p_99155_ + 16, 0, 0.0F, 191.0F, i1 + 1, 5, 512, 256);
            int j1 = this.menu.getFutureTraderXp();
            if (j1 > 0) {
               int k1 = Math.min(Mth.floor((float)j1 * f), 100 - i1);
               blit(p_99153_, p_99154_ + 136 + i1 + 1, p_99155_ + 16 + 1, 0, 2.0F, 182.0F, k1, 3, 512, 256);
            }
   ...
   private void renderScroller(PoseStack p_99158_, int p_99159_, int p_99160_, MerchantOffers p_99161_) {
      ...
      if (i > 1) {
         ...
         blit(p_99158_, p_99159_ + 94, p_99160_ + 18 + i1, 0, 0.0F, 199.0F, 6, 27, 512, 256);
      } else {
         blit(p_99158_, p_99159_ + 94, p_99160_ + 18, 0, 6.0F, 199.0F, 6, 27, 512, 256);
      }
      ...
      if (!merchantoffers.isEmpty()) {
         ...
         for(MerchantOffer merchantoffer : merchantoffers) {
            if (!this.canScroll(merchantoffers.size()) || i1 >= this.scrollOff && i1 < 7 + this.scrollOff) {
               ...
               p_99148_.pushPose();
               p_99148_.translate(0.0F, 0.0F, 100.0F);
               int j1 = k + 2;
               this.renderAndDecorateCostA(p_99148_, itemstack1, itemstack, l, j1);
               if (!itemstack2.isEmpty()) {
                  this.itemRenderer.renderAndDecorateFakeItem(p_99148_, itemstack2, i + 5 + 35, j1);
                  this.itemRenderer.renderGuiItemDecorations(p_99148_, this.font, itemstack2, i + 5 + 35, j1);
               }

               this.renderButtonArrows(p_99148_, merchantoffer, i, j1);
               this.itemRenderer.renderAndDecorateFakeItem(p_99148_, itemstack3, i + 5 + 68, j1);
               this.itemRenderer.renderGuiItemDecorations(p_99148_, this.font, itemstack3, i + 5 + 68, j1);
               p_99148_.popPose();
               k += 20;
               ++i1;
            } else {
   ...
   private void renderButtonArrows(PoseStack p_99169_, MerchantOffer p_99170_, int p_99171_, int p_99172_) {
      ...
      if (p_99170_.isOutOfStock()) {
         blit(p_99169_, p_99171_ + 5 + 35 + 20, p_99172_ + 3, 0, 25.0F, 171.0F, 10, 9, 512, 256);
      } else {
         blit(p_99169_, p_99171_ + 5 + 35 + 20, p_99172_ + 3, 0, 15.0F, 171.0F, 10, 9, 512, 256);
      }

   }

   private void renderAndDecorateCostA(PoseStack p_99163_, ItemStack p_99164_, ItemStack p_99165_, int p_99166_, int p_99167_) {
      this.itemRenderer.renderAndDecorateFakeItem(p_99163_, p_99164_, p_99166_, p_99167_);
      if (p_99165_.getCount() == p_99164_.getCount()) {
         this.itemRenderer.renderGuiItemDecorations(p_99163_, this.font, p_99164_, p_99166_, p_99167_);
      } else {
         this.itemRenderer.renderGuiItemDecorations(p_99163_, this.font, p_99165_, p_99166_, p_99167_, p_99165_.getCount() == 1 ? "1" : null);
         this.itemRenderer.renderGuiItemDecorations(p_99163_, this.font, p_99164_, p_99166_ + 14, p_99167_, p_99164_.getCount() == 1 ? "1" : null);
         RenderSystem.setShaderTexture(0, VILLAGER_LOCATION);
         p_99163_.pushPose();
         p_99163_.translate(0.0F, 0.0F, 300.0F);
         blit(p_99163_, p_99166_ + 7, p_99167_ + 12, 0, 0.0F, 176.0F, 9, 2, 512, 256);
         p_99163_.popPose();
      }
   ...
   class TradeOfferButton extends Button {
      ...
      public void renderToolTip(PoseStack p_99211_, int p_99212_, int p_99213_) {
         if (this.isHovered && MerchantScreen.this.menu.getOffers().size() > this.index + MerchantScreen.this.scrollOff) {
            ...
            } else if (p_99212_ < this.getX() + 50 && p_99212_ > this.getX() + 30) {
