...
public abstract class AbstractContainerScreen<T extends AbstractContainerMenu> extends Screen implements MenuAccess<T> {
   ...
   public void render(PoseStack p_97795_, int p_97796_, int p_97797_, float p_97798_) {
      ...
      p_97795_.pushPose();
      p_97795_.translate((float)i, (float)j, 0.0F);
      ...
      for(int k = 0; k < this.menu.slots.size(); ++k) {
         ...
         if (this.isHovering(slot, (double)p_97796_, (double)p_97797_) && slot.isActive()) {
            ...
            int l = slot.x;
            int i1 = slot.y;
            renderSlotHighlight(p_97795_, l, i1, 0);
         }
      }
      ...
      if (!itemstack.isEmpty()) {
         ...
         this.renderFloatingItem(p_97795_, itemstack, p_97796_ - i - 8, p_97797_ - j - i2, s);
      }
      ...
      if (!this.snapbackItem.isEmpty()) {
         ...
         this.renderFloatingItem(p_97795_, this.snapbackItem, j1, k1, (String)null);
      }
   ...
   private void renderFloatingItem(PoseStack p_275498_, ItemStack p_275341_, int p_275289_, int p_275690_, String p_275201_) {
      p_275498_.pushPose();
      p_275498_.translate(0.0F, 0.0F, 232.0F);
      this.itemRenderer.renderAndDecorateItem(p_275498_, p_275341_, p_275289_, p_275690_);
      this.itemRenderer.renderGuiItemDecorations(p_275498_, this.font, p_275341_, p_275289_, p_275690_ - (this.draggingItem.isEmpty() ? 0 : 8), p_275201_);
      p_275498_.popPose();
   }
   ...
   private void renderSlot(PoseStack p_97800_, Slot p_97801_) {
      ...
      p_97800_.pushPose();
      p_97800_.translate(0.0F, 0.0F, 100.0F);
      if (itemstack.isEmpty() && p_97801_.isActive()) {
         ...
         if (pair != null) {
            ...
            blit(p_97800_, i, j, 0, 16, 16, textureatlassprite);
            flag1 = true;
         }
      }
      ...
      if (!flag1) {
         ...
         this.itemRenderer.renderAndDecorateItem(p_97800_, this.minecraft.player, itemstack, i, j, p_97801_.x + p_97801_.y * this.imageWidth);
         this.itemRenderer.renderGuiItemDecorations(p_97800_, this.font, itemstack, i, j, s);
      }
