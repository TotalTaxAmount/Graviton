...
public class JoinMultiplayerScreen extends Screen {
   ...
   protected void init() {
      ...
      Button button = this.addRenderableWidget(Button.builder(Component.translatable("selectServer.direct"), (p_99724_) -> {
      ...
      Button button1 = this.addRenderableWidget(Button.builder(Component.translatable("selectServer.add"), (p_99720_) -> {
         this.editingServer = new ServerData(I18n.get("selectServer.defaultName"), "", false);
      ...
      Button button3 = this.addRenderableWidget(Button.builder(CommonComponents.GUI_CANCEL, (p_99699_) -> {
