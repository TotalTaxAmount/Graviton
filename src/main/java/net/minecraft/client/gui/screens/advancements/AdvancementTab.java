...
public class AdvancementTab extends GuiComponent {
   ...
   public void drawTab(PoseStack p_97166_, int p_97167_, int p_97168_, boolean p_97169_) {
      this.type.draw(p_97166_, p_97167_, p_97168_, p_97169_, this.index);
   }

   public void drawIcon(PoseStack p_275411_, int p_275531_, int p_275264_, ItemRenderer p_275236_) {
      this.type.drawIcon(p_275411_, p_275531_, p_275264_, this.index, p_275236_, this.icon);
   }

   public void drawContents(PoseStack p_275262_, int p_275430_, int p_275336_) {
      if (!this.centered) {
      ...
      enableScissor(p_275430_, p_275336_, p_275430_ + 234, p_275336_ + 113);
      p_275262_.pushPose();
      p_275262_.translate((float)p_275430_, (float)p_275336_, 0.0F);
      ...
      for(int i1 = -1; i1 <= 15; ++i1) {
         for(int j1 = -1; j1 <= 8; ++j1) {
            blit(p_275262_, k + 16 * i1, l + 16 * j1, 0.0F, 0.0F, 16, 16, 16, 16);
         }
      }

      this.root.drawConnectivity(p_275262_, i, j, true);
      this.root.drawConnectivity(p_275262_, i, j, false);
      this.root.draw(p_275262_, i, j);
      p_275262_.popPose();
      disableScissor();
   }
   ...
   public void drawTooltips(PoseStack p_97184_, int p_97185_, int p_97186_, int p_97187_, int p_97188_) {
      p_97184_.pushPose();
      p_97184_.translate(0.0F, 0.0F, -200.0F);
