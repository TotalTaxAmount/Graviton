...
public class Items {
   ...
   public static final Item SUSPICIOUS_SAND = registerBlock(new BlockItem(Blocks.SUSPICIOUS_SAND, (new Item.Properties()).requiredFeatures(FeatureFlags.UPDATE_1_20)));
   ...
   public static final Item DECORATED_POT = registerBlock(new BlockItem(Blocks.DECORATED_POT, (new Item.Properties()).stacksTo(1).requiredFeatures(FeatureFlags.UPDATE_1_20)));
   ...
   public static final Item CHERRY_BOAT = registerItem("cherry_boat", new BoatItem(false, Boat.Type.CHERRY, (new Item.Properties()).stacksTo(1).requiredFeatures(FeatureFlags.UPDATE_1_20)));
   public static final Item CHERRY_CHEST_BOAT = registerItem("cherry_chest_boat", new BoatItem(true, Boat.Type.CHERRY, (new Item.Properties()).stacksTo(1).requiredFeatures(FeatureFlags.UPDATE_1_20)));
   ...
   public static final Item BAMBOO_RAFT = registerItem("bamboo_raft", new BoatItem(false, Boat.Type.BAMBOO, (new Item.Properties()).stacksTo(1).requiredFeatures(FeatureFlags.UPDATE_1_20)));
   public static final Item BAMBOO_CHEST_RAFT = registerItem("bamboo_chest_raft", new BoatItem(true, Boat.Type.BAMBOO, (new Item.Properties()).stacksTo(1).requiredFeatures(FeatureFlags.UPDATE_1_20)));
   ...
   public static final Item POTTERY_SHARD_ARCHER = registerItem("pottery_shard_archer", new Item((new Item.Properties()).requiredFeatures(FeatureFlags.UPDATE_1_20)));
   ...
   public static final Item POTTERY_SHARD_ARMS_UP = registerItem("pottery_shard_arms_up", new Item((new Item.Properties()).requiredFeatures(FeatureFlags.UPDATE_1_20)));
   ...
   private static Item registerBlock(Block p_252092_, Block... p_248886_) {
   ...
   private static Item registerItem(ResourceLocation p_42817_, Item p_42818_) {
      ...
      return Registry.register(BuiltInRegistries.ITEM, p_42817_, p_42818_);
   }
}