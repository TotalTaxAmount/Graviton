...
public class PiglinAi {
   ...
   public static void angerNearbyPiglins(Player p_34874_, boolean p_34875_) {
      ...
      list.stream().filter(PiglinAi::isIdle).filter((p_34881_) -> {
         ...
         if (p_269951_.level.getGameRules().getBoolean(GameRules.RULE_UNIVERSAL_ANGER)) {
            setAngerTargetToNearestTargetablePlayerIfFound(p_269951_, p_34874_);
         } else {
            setAngerTarget(p_269951_, p_34874_);
         }
   ...
   protected static void wasHurtBy(Piglin p_34838_, LivingEntity p_34839_) {
      if (!(p_34839_ instanceof Piglin)) {
         ...
         getAvoidTarget(p_34838_).ifPresent((p_275123_) -> {
            if (p_275123_.getType() != p_34839_.getType()) {
   ...
   private static BehaviorControl<LivingEntity> babySometimesRideBabyHoglin() {
      ...
      return CopyMemoryWithExpiry.create((p_269953_) -> {
         return p_269953_.isBaby() && setentitylooktargetsometimes$ticker.tickDownAndCheck(p_269953_.level.random);
   ...
   protected static void broadcastAngerTarget(AbstractPiglin p_34896_, LivingEntity p_34897_) {
      getAdultPiglins(p_34896_).forEach((p_275125_) -> {
         if (p_34897_.getType() != EntityType.HOGLIN || p_275125_.canHunt() && ((Hoglin)p_34897_).canBeHunted()) {
