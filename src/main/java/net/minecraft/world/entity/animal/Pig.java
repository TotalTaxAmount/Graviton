...
public class Pig extends Animal implements ItemSteerable, Saddleable {
   ...
   protected void tickRidden(LivingEntity p_275252_, Vec3 p_275534_) {
      super.tickRidden(p_275252_, p_275534_);
      this.setRot(p_275252_.getYRot(), p_275252_.getXRot() * 0.5F);
      this.yRotO = this.yBodyRot = this.yHeadRot = this.getYRot();
      this.steering.tickBoost();
   }

   protected Vec3 getRiddenInput(LivingEntity p_275263_, Vec3 p_275479_) {
      return new Vec3(0.0D, 0.0D, 1.0D);
   }

   protected float getRiddenSpeed(LivingEntity p_275585_) {
