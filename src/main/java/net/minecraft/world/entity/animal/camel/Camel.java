...
public class Camel extends AbstractHorse implements PlayerRideableJumping, RiderShieldingMount, Saddleable {
   ...
   protected void tickRidden(LivingEntity p_275744_, Vec3 p_275586_) {
      super.tickRidden(p_275744_, p_275586_);
      if (p_275744_.zza > 0.0F && this.isCamelSitting() && !this.isInPoseTransition()) {
         this.standUp();
      }
   ...
   protected float getRiddenSpeed(LivingEntity p_252019_) {
   ...
   protected Vec3 getRiddenInput(LivingEntity p_275471_, Vec3 p_275191_) {
      return this.refuseToMove() ? Vec3.ZERO : super.getRiddenInput(p_275471_, p_275191_);
   }
