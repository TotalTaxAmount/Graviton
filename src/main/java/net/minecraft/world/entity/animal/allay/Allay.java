...
public class Allay extends PathfinderMob implements InventoryCarrier {
   ...
   private boolean allayConsidersItemEqual(ItemStack p_252278_, ItemStack p_250405_) {
      return p_252278_.sameItem(p_250405_) && !this.hasNonMatchingPotion(p_252278_, p_250405_);
   }
   ...
   public void readAdditionalSaveData(CompoundTag p_218350_) {
      ...
      if (p_218350_.contains("listener", 10)) {
         VibrationListener.codec(this.vibrationListenerConfig).parse(new Dynamic<>(NbtOps.INSTANCE, p_218350_.getCompound("listener"))).resultOrPartial(LOGGER::error).ifPresent((p_269929_) -> {
            this.dynamicVibrationListener.updateListener(p_269929_, this.level);
         });
      }
