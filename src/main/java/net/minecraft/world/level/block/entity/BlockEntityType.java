...
public class BlockEntityType<T extends BlockEntity> {
   ...
   public static final BlockEntityType<SuspiciousSandBlockEntity> SUSPICIOUS_SAND = register("suspicious_sand", BlockEntityType.Builder.of(SuspiciousSandBlockEntity::new, Blocks.SUSPICIOUS_SAND));
