...
public class ServerEntity {
      ...
      if (this.tickCount % this.updateInterval == 0 || this.entity.hasImpulse || this.entity.getEntityData().isDirty()) {
         if (this.entity.isPassenger()) {
            ...
            if (this.tickCount > 0 || this.entity instanceof AbstractArrow) {
               ...
               if (!flag2 && this.teleportDelay <= 400 && !this.wasRiding && this.wasOnGround == this.entity.isOnGround()) {
   ...
   private Stream<Entity> changedPassengers(List<Entity> p_275537_, List<Entity> p_275682_) {
      return Stream.concat(p_275682_.stream().filter((p_275361_) -> {
         return !p_275537_.contains(p_275361_);
      }), p_275537_.stream().filter((p_275536_) -> {
         return !p_275682_.contains(p_275536_);
      }));
   }
   ...
   public void sendPairingData(Consumer<Packet<ClientGamePacketListener>> p_8537_) {
      ...
      if (this.trackedDataValues != null) {
         p_8537_.accept(new ClientboundSetEntityDataPacket(this.entity.getId(), this.trackedDataValues));
      }
