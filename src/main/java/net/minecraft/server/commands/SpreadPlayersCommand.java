...
public class SpreadPlayersCommand {
   ...
   public static void register(CommandDispatcher<CommandSourceStack> p_138697_) {
      ...
      }).then(Commands.argument("center", Vec2Argument.vec2()).then(Commands.argument("spreadDistance", FloatArgumentType.floatArg(0.0F)).then(Commands.argument("maxRange", FloatArgumentType.floatArg(1.0F)).then(Commands.argument("respectTeams", BoolArgumentType.bool()).then(Commands.argument("targets", EntityArgument.entities()).executes((p_248172_) -> {
         return spreadPlayers(p_248172_.getSource(), Vec2Argument.getVec2(p_248172_, "center"), FloatArgumentType.getFloat(p_248172_, "spreadDistance"), FloatArgumentType.getFloat(p_248172_, "maxRange"), p_248172_.getSource().getLevel().getMaxBuildHeight(), BoolArgumentType.getBool(p_248172_, "respectTeams"), EntityArgument.getEntities(p_248172_, "targets"));
