...
public class Main {
   ...
   public static DataGenerator createStandardGenerator(Path p_236680_, Collection<Path> p_236681_, boolean p_236682_, boolean p_236683_, boolean p_236684_, boolean p_236685_, boolean p_236686_, WorldVersion p_236687_, boolean p_236688_) {
      ...
      TagsProvider<Block> tagsprovider2 = datagenerator$packgenerator2.addProvider(bindRegistries(VanillaBlockTagsProvider::new, completablefuture));
      TagsProvider<Item> tagsprovider = datagenerator$packgenerator2.addProvider((p_274753_) -> {
         return new VanillaItemTagsProvider(p_274753_, completablefuture, tagsprovider2.contentsGetter());
      });
      ...
      CompletableFuture<HolderLookup.Provider> completablefuture1 = UpdateOneTwentyRegistries.createLookup(completablefuture);
      DataGenerator.PackGenerator datagenerator$packgenerator3 = datagenerator.getBuiltinDatapack(p_236683_, "update_1_20");
      datagenerator$packgenerator3.addProvider(UpdateOneTwentyRecipeProvider::new);
      TagsProvider<Block> tagsprovider1 = datagenerator$packgenerator3.addProvider((p_274746_) -> {
         return new UpdateOneTwentyBlockTagsProvider(p_274746_, completablefuture1, tagsprovider2.contentsGetter());
      });
      datagenerator$packgenerator3.addProvider((p_274750_) -> {
         return new UpdateOneTwentyItemTagsProvider(p_274750_, completablefuture1, tagsprovider.contentsGetter(), tagsprovider1.contentsGetter());
      });
      datagenerator$packgenerator3.addProvider(bindRegistries(UpdateOneTwentyBiomeTagsProvider::new, completablefuture1));
      datagenerator$packgenerator3.addProvider(UpdateOneTwentyLootTableProvider::create);
      datagenerator$packgenerator3.addProvider(bindRegistries(UpdateOneTwentyVanillaAdvancementProvider::create, completablefuture1));
      datagenerator$packgenerator3.addProvider(bindRegistries(RegistriesDatapackGenerator::new, completablefuture1));
      datagenerator$packgenerator3.addProvider((p_253389_) -> {
         return PackMetadataGenerator.forFeaturePack(p_253389_, Component.translatable("dataPack.update_1_20.description"), FeatureFlagSet.of(FeatureFlags.UPDATE_1_20));
      });
