...
public class OverworldBiomes {
   ...
   public static Biome sparseJungle(HolderGetter<PlacedFeature> p_255977_, HolderGetter<ConfiguredWorldCarver<?>> p_256531_) {
      ...
      return baseJungle(p_255977_, p_256531_, 0.8F, false, true, false, mobspawnsettings$builder);
   }
   ...
   public static Biome jungle(HolderGetter<PlacedFeature> p_256033_, HolderGetter<ConfiguredWorldCarver<?>> p_255651_) {
      ...
      return baseJungle(p_256033_, p_255651_, 0.9F, false, false, true, mobspawnsettings$builder);
   }
   ...
   public static Biome bambooJungle(HolderGetter<PlacedFeature> p_255817_, HolderGetter<ConfiguredWorldCarver<?>> p_256096_) {
      ...
      return baseJungle(p_255817_, p_256096_, 0.9F, true, false, true, mobspawnsettings$builder);
   }

   private static Biome baseJungle(HolderGetter<PlacedFeature> p_256470_, HolderGetter<ConfiguredWorldCarver<?>> p_256465_, float p_255630_, boolean p_256163_, boolean p_255882_, boolean p_255695_, MobSpawnSettings.Builder p_255859_) {
      BiomeGenerationSettings.Builder biomegenerationsettings$builder = new BiomeGenerationSettings.Builder(p_256470_, p_256465_);
      globalOverworldGeneration(biomegenerationsettings$builder);
      BiomeDefaultFeatures.addDefaultOres(biomegenerationsettings$builder);
      BiomeDefaultFeatures.addDefaultSoftDisks(biomegenerationsettings$builder);
      if (p_256163_) {
      ...
      return biome(true, 0.95F, p_255630_, p_255859_, biomegenerationsettings$builder, music);
   }
