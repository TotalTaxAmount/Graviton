...
public class DataFixers {
   ...
   private static void addFixers(DataFixerBuilder p_14514_) {
      ...
      p_14514_.addFixer(new RecipesFix(schema64, false));
      ...
      p_14514_.addFixer(new RecipesRenameningFix(schema66, false));
      ...
      p_14514_.addFixer(new RecipesRenameFix(schema94, false, "Rename sugar recipe", createRenamer("minecraft:sugar", "sugar_from_sugar_cane")));
      ...
      p_14514_.addFixer(new RenameBiomesFix(schema120, false, "Nether biome rename", ImmutableMap.of("minecraft:nether", "minecraft:nether_wastes")));
      Schema schema121 = p_14514_.addSchema(2553, SAME_NAMESPACED);
      p_14514_.addFixer(new BiomeFix(schema121, false));
      ...
      p_14514_.addFixer(new RenameBiomesFix(schema145, false, "Caves and Cliffs biome renames", CavesAndCliffsRenames.RENAMES));
      ...
      p_14514_.addFixer(new RenameBiomesFix(schema148, false, "Remove Deep Warm Ocean", Map.of("minecraft:deep_warm_ocean", "minecraft:warm_ocean")));
      ...
      Schema schema162 = p_14514_.addSchema(3088, SAME_NAMESPACED);
      p_14514_.addFixer(new BlendingDataFix(schema162));
