...
public class AdvancementRewards {
   ...
   public void grant(ServerPlayer p_9990_) {
      ...
      this.function.get(minecraftserver.getFunctions()).ifPresent((p_275859_) -> {
         minecraftserver.getFunctions().execute(p_275859_, p_9990_.createCommandSourceStack().withSuppressedOutput().withPermission(2));
      });
   }
